...
import { IHeader } from "mfe-shared"

export default ({ currentUser, pathName, module }: IHeader) => {
                                ...
                                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                    {
                                        ...
                                        <li className="nav-item">
                                            <Link href={"/"}>
                                                <a className={`nav-link ${pathName === "/" ? "active" : ""}`}>{module.name === "cart" ? "Shopping Cart" : "Payments"}</a>
                                            </Link>
                                        </li>
                                    }
                                </ul>
